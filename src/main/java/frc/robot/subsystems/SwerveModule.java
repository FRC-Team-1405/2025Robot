...
public double getDistance() 
  {  
    ...
    return (BaseStatusSignal.getLatencyCompensatedValue(driveMotorPosition, driveMotorVelocity).in(Rotations) / gearRatio) * SwerveConstants.WHEEL_CIRCUMFERENCE;//TODO verify the degrees is the right unit
